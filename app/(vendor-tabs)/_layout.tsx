...
type TabName = "index" | "jobs" | "inbox" | "earnings" | "profile";
...
const TAB_ORDER: TabName[] = ["index", "jobs", "inbox", "earnings", "profile"];
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Jobs",
          listeners: () => ({
            focus: () => setActiveIndex(getTabIndex("jobs")),
          }),
        }}
      />
      <Tabs.Screen
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Earnings",
          listeners: () => ({
            focus: () => setActiveIndex(getTabIndex("earnings")),
          }),
        }}
      />
      <Tabs.Screen
