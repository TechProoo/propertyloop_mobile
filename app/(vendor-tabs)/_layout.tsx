...
export default function VendorTabLayout() {
  ...
  // The vendor area is account-only (unlike the buyer tabs, which allow guest
  // browsing per App Store 5.1.1). A logged-out user must never see the vendor
  // dashboard/jobs/earnings/profile — even with placeholder data — so gate the
  // whole group here and send guests to welcome to log in or create an account.
